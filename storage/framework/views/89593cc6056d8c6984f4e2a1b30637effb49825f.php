...
<div class="row">
    ...
    <script>
        ...
        document.addEventListener('livewire:load',()=>{
            ...
            var salesTopData = {
                labels: window.livewire.find('<?php echo e($_instance->id); ?>').dataBulan,
                datasets: [{
                    label: 'Disburse',
                    data: window.livewire.find('<?php echo e($_instance->id); ?>').dataNominalDisburse,
                    ...
                    label: 'Repayment',
                    data: window.livewire.find('<?php echo e($_instance->id); ?>').dataNominalRepayment,
    ...
    <?php $__env->stopPush(); ?>
                      ...
                      <!-- TUTUP ROW LINE CHART --><?php /**PATH C:\xampp\htdocs\cij-dashboard\resources\views/livewire/app/dashboard/p2p/component/jumlah-disburse.blade.php ENDPATH**/ ?>